...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    public RuntimeExceptionDao<Workout, Integer> getWorkoutDao() {
        if (workoutDao == null) {
            workoutDao = getRuntimeExceptionDao(Workout.class);
        }
        return workoutDao;
    }

    public RuntimeExceptionDao<WorkoutPoint, Integer> getWorkoutPointDao() {
        if (workoutPointDao == null) {
            workoutPointDao = getRuntimeExceptionDao(WorkoutPoint.class);
        }
